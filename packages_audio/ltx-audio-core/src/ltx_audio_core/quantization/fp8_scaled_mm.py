...
from ltx_audio_core.model.transformer import LTXModel
from ltx_audio_core.quantization.policy import QuantizationPolicy
from ltx_audio_core.quantization.trtllm_scaled_usable import trtllm_scaled_mm_usable
...
def build_policy(checkpoint_path: str) -> QuantizationPolicy:
    ...
    checkpoints, use :func:`ltx_audio_core.quantization.fp8_cast.build_policy`.
    """
