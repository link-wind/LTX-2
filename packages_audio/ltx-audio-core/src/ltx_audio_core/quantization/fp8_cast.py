...
from ltx_audio_core.loader.fuse_loras import FuseRule, bf16_fuse_rule
from ltx_audio_core.loader.kernels import TRITON_AVAILABLE
from ltx_audio_core.loader.module_ops import ModuleOps
from ltx_audio_core.loader.primitives import StateDict
from ltx_audio_core.loader.sd_ops import KeyValueOperationResult, SDOps
from ltx_audio_core.model.transformer.model import LTXModel
from ltx_audio_core.quantization.policy import QuantizationPolicy
...
def fused_add_round_launch(target_weight: torch.Tensor, original_weight: torch.Tensor, seed: int) -> torch.Tensor:
    if not TRITON_AVAILABLE:
        raise RuntimeError(
            ...
            "Callers should gate on ltx_audio_core.loader.kernels.TRITON_AVAILABLE and use a "
            "deterministic-rounding fallback instead."
        )
    import triton  # noqa: PLC0415

    from ltx_audio_core.loader.kernels import fused_add_round_kernel  # noqa: PLC0415
